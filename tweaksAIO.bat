...
REG ADD "HKLM\SYSTEM\ControlSet001\Control\Processor" /v "ProcessorThrottlingEnabled" /t REG_DWORD /d "0" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\ControlSet001\Control\Processor" /v "ProcessorLatencyThrottlingEnabled" /t REG_DWORD /d "0" /f >NUL 2>&1

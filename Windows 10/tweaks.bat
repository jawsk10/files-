...
REG ADD "HKCU\Control Panel\Desktop" /v "KeyboardSpeed" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKCU\Control Panel\Keyboard" /v "KeyboardDelay" /t REG_SZ /d "0" /f >NUL 2>&1
REG ADD "HKCU\Control Panel\Keyboard" /v "KeyboardSpeed" /t REG_SZ /d "0" /f >NUL 2>&1

...
REG ADD "HKLM\SYSTEM\ControlSet001\Enum\%%n\Device Parameters\Interrupt Management\Affinity Policy" /v "AssignmentSetOverride" /t REG_BINARY /d "04" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ControlSet001\Enum\%%n\Device Parameters\Interrupt Management\Affinity Policy" /v "DevicePolicy" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ControlSet001\Enum\%%n\Device Parameters\Interrupt Management\MessageSignaledInterruptProperties" /v "MessageNumberLimit" /t REG_DWORD /d "256" /f >NUL 2>&1
)
...
:: Disable UWP Store support
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\luafv" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\luafv" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\AppXSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\AppXSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\AppReadiness" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\AppReadiness" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\TokenBroker" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\TokenBroker" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\Themes" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\Themes" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\BITS" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\BITS" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\PimIndexMaintenanceSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\PimIndexMaintenanceSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\PimIndexMaintenanceSvc_2570f" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\PimIndexMaintenanceSvc_2570f" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\DoSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\DoSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NgcSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NgcSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NgcCtnrSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NgcCtnrSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NcbService" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\NcbService" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\WpnService" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\WpnService" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\wuauserv" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\wuauserv" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XboxGipSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XboxGipSvc" /v "Start" /t REG_DWORD /d "3" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XblAuthManager" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XblAuthManager" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XboxNetApiSvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\XboxNetApiSvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\SENS" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\SENS" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\EventSystem" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\EventSystem" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\WinQuic" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\WinQuic" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\iphlpsvc" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\iphlpsvc" /v "Start" /t REG_DWORD /d "4" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\PolicyAgent" /v "ErrorControl" /t REG_DWORD /d "1" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\ControlSet001\Control\GraphicsDrivers\Configuration\BNQ7F58LAL04138SL0_2A_07E4_2E^E866752506E97B4D61FBA5E9F9717023\00\00" /v "PixelFormat" /t Reg_DWORD /d "1" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapFullAboveNormal" /v "CapPercentage" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapFullAboveNormal" /v "PriorityClass" /t REG_DWORD /d "32" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapFullAboveNormal" /v "SchedulingType" /t REG_DWORD /d "0" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapLowBackgroundBegin" /v "CapPercentage" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapLowBackgroundBegin" /v "PriorityClass" /t REG_DWORD /d "32" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\SoftCapLowBackgroundBegin" /v "SchedulingType" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\UnmanagedAboveNormal" /v "CapPercentage" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\UnmanagedAboveNormal" /v "PriorityClass" /t REG_DWORD /d "32" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\CPU\UnmanagedAboveNormal" /v "SchedulingType" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "Capabilities" /t REG_DWORD /d "517734" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\ResourcePolicyStore\ResourceSets\Policies\IO\NoCap" /v "IOBandwidth" /t REG_DWORD /d "0" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\I/O System" /v "IoEnableSessionZeroAccessCheck" /t REG_DWORD /d "1" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Kernel" /v "DisableDynamicTick" /t REG_DWORD /d 0 /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Kernel" /v "TimerInterruptDelay" /t REG_DWORD /d 1 /f >NUL 2>&1
...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Enum\%%u\Device Parameters" /v SelectiveSuspendEnabled /t REG_BINARY /d "0"0 /f
...
reg.exe add "HKLM\System\CurrentControlSet\Enum\%%u\Device Parameters" /v "EnhancedPowerManagementEnabled" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\System\CurrentControlSet\Enum\%%u\Device Parameters" /v "AllowIdleIrpInD3" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\System\CurrentControlSet\Enum\%%u\Device Parameters" /v "EnableSelectiveSuspend" /t REG_DWORD /d "0" /f
...
reg.exe add "HKLM\System\CurrentControlSet\Enum\%%u\Device Parameters" /v "SelectiveSuspendOn" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\System\CurrentControlSet\Enum\%%u\Device Parameters" /v "D3ColdSupported" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Enum\%%u\Device Parameters" /v SelectiveSuspendOn /t REG_DWORD /d "0" /f
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Enum\%%u\Device Parameters" /v SelectiveSuspendEnabled /t REG_BINARY /d "0"0 /f
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Enum\%%u\Device Parameters\WDF" /v IdleInWorkingState /t REG_DWORD /d "0" /f
...
REG DELETE HKLM\COMPONENTS\DerivedData\Components\wow64_wininet.etw_31bf3856ad364e35_10.0.18362.1_none_2f8560056c01225c /F >NUL 2>&1
REG DELETE "HKLM\COMPONENTS\DerivedData\VersionedIndex\10.0.18362.30 (WinBuild.160101.0800)\ComponentFamilies\amd64_wininet.etw_31bf3856ad364e35_none_7e553f52ba809ea7" /F >NUL 2>&1
REG DELETE "HKLM\COMPONENTS\DerivedData\VersionedIndex\10.0.18362.30 (WinBuild.160101.0800)\ComponentFamilies\wow64_wininet.etw_31bf3856ad364e35_none_88a9e9a4eee160a2" /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-WinINet/UsageLog /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-WinINet/WebSocket /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-WinINet-Capture/Analytic /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-WinINet-Config/ProxyConfigChanged /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Publishers\{5402e5ea-1bdd-4390-82be-e108f1e634f5} /F >NUL 2>&1
REG DELETE HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WINEVT\Publishers\{a70ff94f-570b-4979-ba5c-e59c9feab61b} /F >NUL 2>&1
REG DELETE "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks\{4B79A419-F671-47D7-B001-888A456864AE}" /F >NUL 2>&1
REG DELETE HKLM\COMPONENTS\DerivedData\Components\amd64_wininet.etw_31bf3856ad364e35_10.0.18362.1_none_2530b5b337a06061 /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\AppID\{3eb3c877-1f16-487c-9050-104dbcd66683} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\AppID\{F9717507-6651-4EDB-BFF7-AE615179BCCF} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\CLSID\{0358b920-0ac7-461f-98f4-58e32cd89148} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\CLSID\{057EEE47-2572-4AA1-88D7-60CE2149E33C} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\CLSID\{c39ee728-d419-4bd4-a3ef-eda059dbd935} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Interface\{a168aadc-1674-49da-ad4f-4f27df8760d0} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Interface\{B06B0CE5-689B-4AFD-B326-0A08A1A647AF} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\WinInetBroker.WinInetBroker /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\WinInetBroker.WinInetBroker.1 /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\WinInetCache.WinInetCache /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\WinInetCache.WinInetCache.1 /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Wow6432Node\CLSID\{0358b920-0ac7-461f-98f4-58e32cd89148} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Wow6432Node\CLSID\{057EEE47-2572-4AA1-88D7-60CE2149E33C} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Wow6432Node\CLSID\{c39ee728-d419-4bd4-a3ef-eda059dbd935} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Wow6432Node\Interface\{a168aadc-1674-49da-ad4f-4f27df8760d0} /F >NUL 2>&1
REG DELETE HKLM\Software\Classes\Wow6432Node\Interface\{B06B0CE5-689B-4AFD-B326-0A08A1A647AF} /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Internet Explorer\Capabilities\Roaming\WinInet /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks\{325B4FF1-5F84-4166-A23F-FB7825145862} /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree\Microsoft\Windows\Wininet /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows\CurrentVersion\SideBySide\Winners\amd64_wininet.etw_31bf3856ad364e35_none_7e553f52ba809ea7 /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows\CurrentVersion\SideBySide\Winners\wow64_wininet.etw_31bf3856ad364e35_none_88a9e9a4eee160a2 /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-WinINet/Analytic /F >NUL 2>&1
REG DELETE HKLM\Software\Microsoft\Windows\CurrentVersion\WINEVT\Publishers\{43d1a55c-76d6-4f7e-995c-64c711e5cafe} /F >NUL 2>&1
REG DELETE HKLM\Software\Wow6432Node\Microsoft\Internet Explorer\Capabilities\Roaming\WinInet /F >NUL 2>&1
REG DELETE HKLM\System\ControlSet001\Control\Ubpm /F >NUL 2>&1
REG DELETE HKLM\System\ControlSet002\Control\Ubpm /F >NUL 2>&1

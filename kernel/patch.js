/**
 * patchret.js - Function patcher for WinDbg
 * Patches kernel functions with RET (C3) instructions
 * 
 * Usage:
 *   .scriptload path\to\patchret.js
...
function initializeScript() {
    return [
        ...
        new host.functionAlias(patchFunction, "patchret"),

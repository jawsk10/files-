...
REG ADD "HKLM\System\CurrentControlSet\Control\Session Manager\Memory Management" /v "FeatureSettingsOverride" /t REG_DWORD /d "0x2000003" /f >NUL 2>&1
REG ADD "HKLM\System\CurrentControlSet\Control\Session Manager\Memory Management" /v "FeatureSettingsOverrideMask" /t REG_DWORD /d "0x2000003" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v SchedulerAssistThreadFlagOverride /t REG_DWORD /d 2 /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v XStateContextLookasidePerProcMaxDepth /t REG_DWORD /d 0 /f >NUL 2>&1

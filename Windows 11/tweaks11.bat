...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v MaximumSharedReadyQueueSize /t REG_DWORD /d 0 /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v DynamicDpcProtocol /t REG_DWORD /d 0 /f >NUL 2>&1

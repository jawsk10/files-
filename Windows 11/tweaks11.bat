...
:: Miscellaneous
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\xusb22\Parameters" /v "IoQueueWorkItem" /t REG_DWORD /d "0xa" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\USBXHCI\Parameters" /v "IoQueueWorkItem" /t REG_DWORD /d "0xa" /f >NUL 2>&1
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\usbhub\Parameters" /v "IoQueueWorkItem" /t REG_DWORD /d "0xa" /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v BoostingPeriodMultiplier /t REG_DWORD /d 0 /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v DefaultHeteroCpuPolicy /t REG_DWORD /d 4 /f >NUL 2>&1
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v AmdTprLowerInterruptDelayConfig /t REG_DWORD /d 1 /f >NUL 2>&1

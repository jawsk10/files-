...
icacls c:\windows\system32\speech /grant administrators:f /t
rd /s /q c:\windows\speech
rd /s /q c:\windows\system32\speech
takeown /f c:\windows\system32\catsrv.dll
icacls c:\windows\system32\catsrv.dll /grant administrators:f
ren c:\windows\system32\catsrv.dll catsrv.dl
takeown /f c:\windows\system32\catsrv.dll
icacls c:\windows\system32\catsrv.dll /grant administrators:f
ren c:\windows\system32\catsrv.dll catsrv.dl
takeown /f c:\windows\system32\catsrvut.dll
icacls c:\windows\system32\catsrvut.dll /grant administrators:f
ren c:\windows\system32\catsrvut.dll catsrvut.dl
takeown /f c:\windows\system32\catsrvps.dll
icacls c:\windows\system32\catsrvps.dll /grant administrators:f
ren c:\windows\system32\catsrvps.dll catsrvps.dl
takeown /f c:\windows\system32\clbcatq.dll
icacls c:\windows\system32\clbcatq.dll /grant administrators:f
ren c:\windows\system32\clbcatq.dll clbcatq.dl
takeown /f c:\windows\system32\comsvcs.dll
icacls c:\windows\system32\comsvcs.dll /grant administrators:f
ren c:\windows\system32\comsvcs.dll comsvcs.dl
takeown /f c:\windows\system32\pla.dll
icacls c:\windows\system32\pla.dll /grant administrators:f
ren c:\windows\system32\pla.dll pla.dl
echo takeown /f c:\windows\syswow64\imageres.dll
echo icacls c:\windows\syswow64\imageres.dll /grant administrators:f
echo ren c:\windows\syswow64\imageres.dll imageres.dl
echo del /f c:\windows\syswow64\imageres.dl /q
echo off
...
icacls c:\windows\system32\wbem /grant administrators:f /t
takeown /f c:\windows\syswow64\wbem /r /d y
icacls c:\windows\syswow64\wbem /grant administrators:f /t
...
setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\rpceptmapper" -ot reg -actn setowner -ownr "n:administrators" -rec yes
...
ren c:\windows\system32\drivers\rassstp.sys rassstp.sy
...
echo takeown /f c:\windows\syswow64\nlsdata0000.dll
echo icacls c:\windows\syswow64\nlsdata0000.dll /grant administrators:f
echo del /f c:\windows\syswow64\nlsdata0000.dll /q
echo takeown /f c:\windows\syswow64\nlsdata000a.dll
...
echo c:\windows\syswow64\nlsmodels0011.dll /q
echo c:\windows\syswow64\korwbrkr.lex
echo c:\windows\syswow64\korwbrkr.lex /grant administrators:f
echo c:\windows\syswow64\korwbrkr.lex /q
